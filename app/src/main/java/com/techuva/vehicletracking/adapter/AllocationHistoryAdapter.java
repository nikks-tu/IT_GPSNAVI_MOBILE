...
public class AllocationHistoryAdapter extends BaseAdapter {
    private final int resource;
    private Context mContext;
    List<DeviceAllocationHistoryModel> list;
    GenerateMap map;

    public AllocationHistoryAdapter(int resource, Context mContext, List<DeviceAllocationHistoryModel> list) {
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        final DeviceAllocationHistoryModel model = list.get(position);

        String dateToParse = model.getTAGASSIGNEDON();
        ...
        holder.tv_device_serial.setText(model.getTAGNAME());
        holder.tv_allocated_by.setText(model.getTAGASSIGNEDBYNAME());
