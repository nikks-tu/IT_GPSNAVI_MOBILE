...
import com.techuva.vehicletracking.adapter.DriverAllocationHistoryAdapter;
...
public class DriverAllocationHistory extends AppCompatActivity {
    ...
    int vehicleMasterId;
    String searchKey = "";
    DriverAllocationHistoryAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_allocation_history);
        init();
        setTypeface();
        ...
        adapter = new DriverAllocationHistoryAdapter(R.layout.item_allocation_history, this, historyList);
    ...
    private void init() {
        context = DriverAllocationHistory.this;
        ...
        tv_title.setText(context.getResources().getString(R.string.driver_allocation_history));
    }
                       ...
                       // Toast.makeText(context, "Respo", Toast.LENGTH_SHORT).show();
                        ...
                        if(jsonArray.size()>0)
                        {
                            ...
                            if(historyList.size()>0)
                            {
                                ...
                                tv_device_serial_heading.setText("Driver\nName");
